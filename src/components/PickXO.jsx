...
function winingSystem(gameItems, setGameItem) {
    // for diagonals
    let diagonals = [[], []];
...
function PickXO(prop) {
    ...
    React.useEffect(() => {
        let res = winingSystem(gameItems, setGameItem);
        prop.resultAndRestart(res);
    }, []);
                            ...
                            <button
                                ...
                                onClick={() => {
                                    setGameItem((prevGameItems) => {
                                        ...
                                        winingSystem(gameItems, setGameItem);
